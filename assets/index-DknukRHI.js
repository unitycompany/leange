...
`,PC=k.div`
  ...
  max-width: 100%;
  margin: 0 auto;
`,AC=({content:e=[],spaceBetween:t=10,autoplayDelay:n=3e3,showPagination:r=!0,showNavigation:i=!0})=>(Sl(),u.jsxs(PC,{children:[u.jsx(_C,{}),u.jsx(Jt,{modules:[hr,mr,Rn],navigation:i,pagination:!1,spaceBetween:t,loop:!0,slidesPerView:1,autoplay:{delay:n,disableOnInteraction:!1,pauseOnMouseEnter:!0},breakpoints:{640:{slidesPerView:1},1024:{slidesPerView:3}},children:e.map((o,a)=>u.jsxs(en,{children:[u.jsx(jC,{}),u.jsx(TC,{style:{backgroundImage:`url(${o.backgroundImage})`},children:u.jsxs(CC,{"data-aos":"fade-down","data-aos-delay":"100",children:[u.jsx(kC,{children:o.title}),u.jsx(EC,{children:o.subtitle}),u.jsx(zC,{children:o.features.map((s,l)=>u.jsxs("span",{children:[s.icon," ",s.text]},l))}),u.jsx(uf,{onClick:()=>{const s=`/leange/#/acomoda${o.id}`;window.location.href=s},text:"Conhecer essa acomodação",suiteId:o.id})]})})]},a))})]})),MC=In`
  0% {
    transform: scale(1);
  }
  50% {
